...
// si les coordonnées du marqueur sont présentes, on les utilise pour créer le marqueur
if (markerCoords) {
  var latLng = markerCoords.split(',');
  var marker = L.marker([latLng[0], latLng[1]], { icon: cardIcon1 }).addTo(map);
}
