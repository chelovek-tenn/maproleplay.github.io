...
L.marker([-5742.5, 2957], {icon: cardIcon14}).addTo(map)
  ...
  L.marker([-5552.5, 3527.25], {icon: cardIcon14}).addTo(map)
    ...
    .bindPopup("<h2>Banque rurale</h2><img class='logo' src='https://i.postimg.cc/4d2SmHxT/image.png'><p><a href='https://i.postimg.cc/qRk3DT6b/Screenshot-2023-01-03-03-00-51-76-572064f74bd5f9fa804b05334aa4f912.jpg' data-lightbox='image-4' data-title='Fleeca Bank'>Ouvrir le visuel du lieu</a><h3>Blaine County bank</h3></p>");
...
L.marker([-5724, 3654.5], {icon: cardIcon35}).addTo(map)
  ...
  L.marker([-5682.5, 2991], {icon: cardIcon37}).addTo(map)
    .bindPopup("<h2>Rockford Hills (Building across from Life Invader)</h2><p><a href='https://content.rockstarnews.ru/up/images/bda0aefd7d9624ebf4d88dce6eae5f30.jpg' data-lightbox='image-11' data-title='Rockford Hills (Building across from Life Invader)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-5601, 2760.5], {icon: cardIcon38}).addTo(map)
    .bindPopup("<h2>Richman (Backyard of mansion at intersection of West Eclipse and Tongva Drive)</h2><p><a href='https://content.rockstarnews.ru/up/images/b1e4025b64ec61a86f00938b805e4aec.png' data-lightbox='image-11' data-title='Richman (Backyard of mansion at intersection of West Eclipse and Tongva Drive)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-5875, 3008], {icon: cardIcon39}).addTo(map)
    .bindPopup("<h2>Richards Majestic (Movie Studio)</h2><p><a href='https://content.rockstarnews.ru/up/images/68c7b2432530c612d8bd121a4c2e26af.png' data-lightbox='image-11' data-title='Richards Majestic (Movie Studio)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-2030.5, 5687], {icon: cardIcon40}).addTo(map)
    .bindPopup("<h2>Del Perro Beach (End of the pier)</h2><p><a href='https://content.rockstarnews.ru/up/images/4e2d58a8a39458014d4647e519887eaf.png' data-lightbox='image-11' data-title='Del Perro Beach (End of the pier)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-6271, 2911.5], {icon: cardIcon41}).addTo(map)
    .bindPopup("<h2>Vespucci Canals (Barber Shop)</h2><p><a href='https://content.rockstarnews.ru/up/images/c67cb451c21becfcf7c57e33d8562090.jpg' data-lightbox='image-11' data-title='Vespucci Canals (Barber Shop)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-6557.5, 2962.5], {icon: cardIcon42}).addTo(map)
    .bindPopup("<h2>Vespucci Beach (Musclehead Gym)</h2><p><a href='https://content.rockstarnews.ru/up/images/c643ea35c09162d9635278c45e3fb67b.png' data-lightbox='image-11' data-title='Vespucci Beach (Musclehead Gym)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-6900, 3968], {icon: cardIcon43}).addTo(map)
    .bindPopup("<h2>Little Seoul (Tram station near Heli Tours)</h2><p><a href='https://content.rockstarnews.ru/up/images/d3b7a8f62abe58fabd61a19cd87dab97.jpg' data-lightbox='image-11' data-title='Little Seoul (Tram station near Heli Tours)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-6263, 3768.5], {icon: cardIcon44}).addTo(map)
    .bindPopup("<h2>Ammu-nation with shooting range (Pillbox Hill)</h2><p><a href='https://content.rockstarnews.ru/up/images/5fdc4701721cc68dcf1fe9f25b022e5f.jpg' data-lightbox='image-11' data-title='Ammu-nation with shooting range (Pillbox Hill)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-3087.5, 2907.75], {icon: cardIcon45}).addTo(map)
    .bindPopup("<h2>Vanilla Unicorn</h2><p><a href='https://content.rockstarnews.ru/up/images/0442e218eefdd63864a816b914930d24.jpg' data-lightbox='image-11' data-title='Vanilla Unicorn'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-6613, 3897.5], {icon: cardIcon46}).addTo(map)
    .bindPopup("<h2>Davis Fire Department on Macdonald Street</h2><p><a href='https://content.rockstarnews.ru/up/images/d42aba2c28b4cb1fd4c5f7e4002b70de.png' data-lightbox='image-11' data-title='Davis Fire Department on Macdonald Street'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-6856, 3719], {icon: cardIcon47}).addTo(map)
    .bindPopup("<h2>Davis (Maze Bank Arena parking lot)</h2><p><a href='https://content.rockstarnews.ru/up/images/ed64f6446b9a8a4fde7932b1d54585fa.jpg' data-lightbox='image-11' data-title='Davis (Maze Bank Arena parking lot)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-2384.5, 5159], {icon: cardIcon48}).addTo(map)
    .bindPopup("<h2>LS Intl. Airport (First floor front entrance of LSIA)</h2><p><a href='https://content.rockstarnews.ru/up/images/d885f0751ccef4a4d3015f362427cb9a.jpg' data-lightbox='image-11' data-title='LS Intl. Airport (First floor front entrance of LSIA)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-6178, 4507], {icon: cardIcon53}).addTo(map)
    .bindPopup("<h2>Rob’s Liquor (Murrieta Heights)</h2><p><a href='https://content.rockstarnews.ru/up/images/755bbec3f4e58f30d7f1de57da5c4004.jpg' data-lightbox='image-11' data-title='Robs Liquor (Murrieta Heights)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-6619.5, 4632.5], {icon: cardIcon52}).addTo(map)
    .bindPopup("<h2>El Burro Heights (Tattoo Parlor)</h2><p><a href='https://content.rockstarnews.ru/up/images/0bb0aad07706d7bada4f881d9a3b387e.jpg' data-lightbox='image-11' data-title='El Burro Heights (Tattoo Parlor)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-6717, 4404.5], {icon: cardIcon51}).addTo(map)
    .bindPopup("<h2>La Mesa (Behind cheap vehicle warehouse)</h2><p><a href='https://content.rockstarnews.ru/up/images/57bb237c11b556f1d09b5fe48aef2e09.png' data-lightbox='image-11' data-title='La Mesa (Behind cheap vehicle warehouse)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-3249.5, 5568.5], {icon: cardIcon50}).addTo(map)
    .bindPopup("<h2>Ammu-nation with shooting range (Cypress Flats)</h2><p><a href='https://content.rockstarnews.ru/up/images/1088c4e0602025b1b1fed1b8f51b0fcb.jpg' data-lightbox='image-11' data-title='Ammu-nation with shooting range (Cypress Flats)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-2688, 5536.5], {icon: cardIcon49}).addTo(map)
    .bindPopup("<h2>Terminal (Jetsam Terminal Building)</h2><p><a href='https://content.rockstarnews.ru/up/images/51b8ea8b3ee82b853d6c23394f2a69ed.jpg' data-lightbox='image-11' data-title='Terminal (Jetsam Terminal Building)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
  L.marker([-5963, 3888], {icon: cardIcon54}).addTo(map)
    .bindPopup("<h2>Pillbox Hill (Between FBI & IAA)</h2><p><a href='https://content.rockstarnews.ru/up/images/c23af6414f51829305492271523aff12.jpg' data-lightbox='image-11' data-title='Pillbox Hill (Between FBI & IAA)'>Open In-Game Screenshot</a></p><div class='input-group input-group-sm mb-3'><input type='text' class='form-control' id='copy' value='https://rockstarnews.ru/map/#5/-1140.750/3857.500'><div class='input-group-append'><button class='btn btn-outline-secondary copy' data-clipboard-target='#copy' type='button'>Copy</button></div></div>");
