...
if (hashParams && hashParams.marker) {
    ...
    var numMarker = L.Icon.extend({ options: { iconSize:[32,37], iconAnchor:[16,37]}}),
        cardIcon1 = new numMarker({iconUrl:"markers/ammu.png"});

    L.marker([markerCoords[0], markerCoords[1]], {icon: cardIcon1}).addTo(map);
}
            }
        }
    };
